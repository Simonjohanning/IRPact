 ...
 */
public abstract class BoundedContinuousDistribution extends DiscreteDistribution{
     ...
     */
    public BoundedContinuousDistribution(String name, double lowerBound, double upperBound) throws IllegalArgumentException{
        super(name);
     ...
     */
    public BoundedContinuousDistribution(String name, double bound, boolean boundUpper) {
        super(name);
        if(boundUpper){
            upperBound=bound;
